...
class ManageServerPeriodicExport extends Module {
    ...
    private fillForm(
        ...
        if(uploadToServer) {
            ...
            switch(serverName) {
                case ManageServerPeriodicExport.REMOTE_SERVER_GLACIER:
                case ManageServerPeriodicExport.REMOTE_SERVER_S3:
                    ...
                    break
                case ManageServerPeriodicExport.REMOTE_SERVER_AZURE:
